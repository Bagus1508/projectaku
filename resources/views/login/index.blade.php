...
<div class="flex items-center justify-center h-screen bg-gray-100">
    <div class="px-8 py-6 text-left bg-white shadow-lg">
        ...
        <h3 class="text-2xl font-bold text-center text-blue-600">Silahkan Login</h3>
        <form action="/login" method="POST">
            @csrf
            <div class="mt-4">
                <div>
                    <label class="block" for="username">NIM<label>
                            <input type="text" placeholder="NIM" name="username" id="username"
                                class="form-control w-full px-4 py-2 mt-2 border rounded-md focus:outline-none focus:ring-1 focus:ring-blue-600 @error('username') invalid:bg-red-500 @enderror" required>
                </div>
                <div class="mt-4">
